...
@Entity
@Table(name = "satin_siparis_satir", catalog = "terp", schema = "terp")
public class PurchaseOrderLine extends CommonFields implements Serializable {
    ...
    public Long getSourceRequestLineId() {
        return sourceRequestLineId;
    }

    public void setSourceRequestLineId(Long sourceRequestLineId) {
