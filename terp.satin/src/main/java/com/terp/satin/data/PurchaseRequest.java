...
@Entity
@Table(name = "satin_talep", catalog = "terp", schema = "terp",
        uniqueConstraints = {
            @UniqueConstraint(name = "ix_satin_talep_firma", columnNames = {"firma_ref", "belge_no"})
        })
public class PurchaseRequest extends CommonFields implements Serializable, ICompanyScoped {
    ...
    @Column(name = "depo_kodu", length = 50)
    ...
    public boolean isConverted() {
        return getStatus() == STATUS_CONVERTED;
    }
