...
@Entity
@Table(name = "stok_sayim", catalog = "terp", schema = "terp",
        uniqueConstraints = {
            @UniqueConstraint(name = "ix_stok_sayim_firma", columnNames = {"firma_ref", "belge_no"})
        })
public class StockCount extends CommonFields implements Serializable, ICompanyScoped {
